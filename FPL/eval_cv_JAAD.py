...
if __name__ == "__main__":
    ...
    parser.add_argument('--root_dir', type=str, default='experiments/JAAD_test')
    parser.add_argument('--in_data', type=str, default='utils/dataset/vit_JAAD_test.joblib')
    ...
    parser.add_argument('--resume', type=str, default='experiments/JAAD_train/230626_103842/model_1000000.npz')
