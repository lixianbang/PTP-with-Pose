...
if __name__ == "__main__":
    ...
    parser.add_argument('--root_dir', type=str, default='experiments/5fold_230519_193030')
    parser.add_argument('--in_data', type=str, default='utils/dataset/id_list_20_230519_194509_30_sp3_2_5.joblib')
    ...
    parser.add_argument('--resume', type=str, default='experiments/5fold_230519_193030/230522_191240/model_17000.npz')
