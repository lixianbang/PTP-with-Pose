...
if __name__ == "__main__":
    ...
    parser.add_argument('--indir_list', type=str, default='id_JAAD_test.txt')
    parser.add_argument('--traj_length', type=int, default=93)
    ...
    data_dir = "E:/person_method/fpl-master/data/"

    date = datetime.datetime.now()
    out_fn = "dataset/vit_JAAD_test.joblib"
    h, w = args.height, args.width

    vid_list = read_vid_list(args.indir_list)
    ...
    for video_id in vid_list:
        trajectory_path = os.path.join(
            data_dir, "JAAD_JSON/out2FPL_JAAD_{}.json".format(video_id))
        ...
        if args.ego_type == "sfm":
            egomotion_path = os.path.join(data_dir, "egomotions/vit_egomotion.csv")
        ...
        for pid in pids:
            ...
            def add_sample(split):
                ...
                turn_mag = np.max(lr_mag_list[2:8])
        ...
        print(video_id, pid_cnt, traj_cnt)
