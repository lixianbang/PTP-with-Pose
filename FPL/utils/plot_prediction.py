...
if __name__ == "__main__":
    ...
    * output_dir: directory to plot images
    ...
    # Data
    parser.add_argument('--fold_path', type=str, default='E:\person_method/fpl-master\experiments/5fold_230519_193030/230522_135426')
    parser.add_argument('--traj_type', type=int, default=0)
    parser.add_argument('--video_ids', type=str, nargs="*", default='GOPR0234U20')
