...
if __name__ == "__main__":
    ...
    * pid: person id number
    ...
    parser.add_argument('--fold_path', type=str,
                        default='E:\person_method/fpl-master\experiments/5fold_230519_193030/230522_135426')
    parser.add_argument('--traj_type', type=int, default=0)
    parser.add_argument('--vid', type=str, default='GOPR0234U20')
    parser.add_argument('--frame', type=int, default=110)
    parser.add_argument('--pid', type=int, default=61)
    ...
    parser.add_argument('--no_pred', action='store_true', default=0)
    ...
    def draw_past(img_dir, b, offset):
        ...
        # Past
        if offset > 0:
            cv2.circle(im, (int(past[0][0]), int(past[0][1])-200), args.size_circle, color_ps, -1)
    ...
    def draw_prediction(img_dir, b, offset_g, offset_p, predictions, img_offset, no_pred=False, no_gt=False):
        ...
        if not args.no_gt:
            ...
            if offset_g > -1:
                cv2.circle(im, (int(ground_truth[0][0]), int(ground_truth[0][1]-200)), args.size_circle, color_gt, -1)
